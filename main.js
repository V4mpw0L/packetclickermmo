  ...
  const gemButtons = GEM_PACKS.map((p) =>
    renderButton({
      ...
      label: `<div class="shop-premium-content" style="min-height:64px;">
        <div class="shop-gem-amount" style="font-size:1.3rem;">${p.gems.toLocaleString("en-US")} <img src="src/assets/gem.png" alt="Gems" style="height:1.3rem;width:1.3rem;vertical-align:middle;display:inline-block;margin-left:0.2rem;" aria-hidden="true"/></div>
