...
function showLevelUpModal(newLevel, oldLevel) {
  ...
  modal.style.width = "min(90vw, 20rem)";
  modal.style.maxWidth = "20rem";

  modal.innerHTML = `
    <div style="text-align: center; padding: 1.5rem;">
      <div style="font-size: 3rem; margin-bottom: 0.75rem; animation: levelUpCelebration 2s ease-in-out infinite;">
        ${levelDiff > 1 ? "🌟" : "⭐"}
      </div>
      <h2 style="font-size: 1.5rem; font-weight: bold; color: var(--primary-color); margin-bottom: 0.75rem; text-shadow: 0 0 10px rgba(29, 233, 182, 0.5);">
        ${title}
      </h2>
      ...
      <div style="display: flex; align-items: center; justify-content: center; gap: 0.5rem; margin: 1rem 0; padding: 0.75rem; background: linear-gradient(135deg, rgba(29, 233, 182, 0.15), rgba(29, 233, 182, 0.05)); border: 2px solid var(--primary-color); border-radius: 8px; box-shadow: 0 0 15px rgba(29, 233, 182, 0.3);">
...
function migrateSaveToCurrentVersion() {
  ...
  // Ensure level system exists (v0.0.45+)
